...
import { Groq } from 'groq-sdk'; // Importa a biblioteca da Groq
...
// Conecta com a API da Groq usando a chave do seu painel do Render
// Certifique-se de adicionar a variável GROQ_API_KEY no painel do Render!
...
4. LIMITAÇÃO TÉCNICA: Realiza apenas manutenção corretiva e preventiva básica (formatação, limpeza interna, troca de pasta térmica, upgrade de SSD/Memória, troca de peças defeituosas e otimização). Ele NÃO faz reparos de eletrônica avançada (como solda em placa-mãe ou recondicionamento de circuitos).
...
app.post('/chat', async (req, res) => {
    try {
        ...
        // Chama o modelo Llama 3 da Meta através da Groq
        const chatCompletion = await groq.chat.completions.create({
            messages: [
                { role: 'system', content: regrasDoChatbot },
                { role: 'user', content: textoUsuario }
            ],
            model: 'llama3-8b-8192', // Modelo rápido, inteligente e com ótima cota gratuita
            temperature: 0.5,
        });
